# LINKS: 
# Base VM: https://github.com/KopiCloud/terraform-gcp-debian-vm
# https://github.com/dcos-terraform/terraform-gcp-instance/blob/support/0.2.x/main.tf
# https://github.com/PaloAltoNetworks/GCP-Terraform-Samples/blob/master/Two-Tier/Main.tf
